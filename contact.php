...
if(isset($_POST['submit'])){
    ...
    if(!empty($email) && !empty($name) && !empty($subject) && !empty($message)){
        ...
        if(filter_var($email, FILTER_VALIDATE_EMAIL) === false){
            ...
            $toEmail = 'yogey264@gmail.com'; // Ganti dengan alamat email yang Anda inginkan
...
<div class="mainContent">
    <h2>Kontak Form PHP / <small><a href="http://www.jurnalweb.com">YogiChandra.github.io</a></small></h2>
